    ...
    <div class="tab-sec">
		<div class="tab">
			<button class="tablinks" onclick="vw_transport_cargo_open_tab(event, 'block_pattern')"><?php esc_html_e( 'Setup With Block Pattern', 'vw-transport-cargo' ); ?></button>
		  	<button class="tablinks" onclick="vw_transport_cargo_open_tab(event, 'theme_lite')"><?php esc_html_e( 'Setup With Customizer', 'vw-transport-cargo' ); ?></button>
		...
		<div id="block_pattern" class="tabcontent open">
			...
			<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vw-transport-cargo'); ?></p>
          	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon >> Click Pattern Tab >> Click on homepage sections >> Publish.','vw-transport-cargo'); ?></span></b></p>
          	<div class="vw-transport-cargo-pattern-page">
		    	<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=page' ) ); ?>" target="_blank" class="vw-pattern-page-btn button-primary button"><?php esc_html_e('Add New Page','vw-transport-cargo'); ?></a>
		    </div>
