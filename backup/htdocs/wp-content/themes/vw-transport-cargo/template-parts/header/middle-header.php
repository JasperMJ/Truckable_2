...
<div class="main-header">
  <div class="container">
    ...
    <div class="serach_outer">
     ...
     <div class="header-menu <?php if( get_theme_mod( 'vw_transport_cargo_sticky_header', false) != '' || get_theme_mod( 'vw_transport_cargo_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
