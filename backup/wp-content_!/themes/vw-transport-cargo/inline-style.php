<?php
	...
	if($vw_transport_cargo_copyright_alingment != false){
		$vw_transport_cargo_custom_css .='.copyright p{';
			$vw_transport_cargo_custom_css .='text-align: '.esc_attr($vw_transport_cargo_copyright_alingment).';';
		$vw_transport_cargo_custom_css .='}';
	}
	...
	$vw_transport_cargo_products_border_radius = get_theme_mod('vw_transport_cargo_products_border_radius');
