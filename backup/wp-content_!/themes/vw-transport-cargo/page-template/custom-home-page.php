...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_transport_cargo_slider_hide_show', false) != '' || get_theme_mod( 'vw_transport_cargo_resp_slider_hide_show', false) != '') { ?>

  <section id="slider">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod( 'vw_transport_cargo_slider_speed',3000)); ?>"> 
